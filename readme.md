...
GenEditDist is a command line tool for finding approximate occurrences of a string in a dictionary. 
It employs regular edit distance (the Levenshtein distance) in combination with an user-defined set of weighted transformations to find approximate matches.
